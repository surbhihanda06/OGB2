...
//  Chnen
//
//  Created by navjot_sharma on 11/23/16.
...
class ProductDetailViewController: UIViewController ,UIScrollViewDelegate,UIWebViewDelegate,UITextViewDelegate,UITextFieldDelegate
{
